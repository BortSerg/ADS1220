...
void ADS1220 :: WtiteConfig (uint8_t address, uint8_t value){
...
void ADS1220 :: SetDefaultSettings (void){
    WtiteConfig (config_address_reg0, default_value_reg0);
    WtiteConfig (config_address_reg1, default_value_reg1);
    WtiteConfig (config_address_reg2, default_value_reg2);
    WtiteConfig (config_address_reg3, default_value_reg3);
}
